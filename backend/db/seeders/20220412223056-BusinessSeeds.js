  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Businesses', [
...

      {
        ...
        lng: 0,
        category: 'Family-owned',
        imageUrls: ['https://shelf-img-bucket.s3.us-west-1.amazonaws.com/family5a.jpg','https://shelf-img-bucket.s3.us-west-1.amazonaws.com/family5b.png', 'https://shelf-img-bucket.s3.us-west-1.amazonaws.com/family5c.jpg'],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
